...
If the current class/module already does this well, writ may add little beyond
...
See the typechecked
[writ-shaped Zustand recipe](../../apps/state-library-recipes/src/zustand-writ-shaped.ts)
